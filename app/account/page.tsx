...
import { FaUser, FaPhone, FaEnvelope, FaMapMarkerAlt, FaHistory, FaHeart, FaCog, FaArrowLeft } from 'react-icons/fa'
...
const AccountPage = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#F6F7F6] to-[#F9F7F6]">
      <Header />
      ...
      <div className="container mx-auto px-4 pt-28">
        <Link 
          href="/"
          className="inline-flex items-center gap-2 text-[#045B62] hover:text-[#02393E] transition-colors duration-300 font-arabic mb-8"
        >
          <FaArrowLeft />
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="section-title">
              ...
              <br />
              <span className="text-2xl text-[#045B62] english-text font-medium">My Profile</span>
            </h2>
            <p className="text-lg text-[#045B62] max-w-3xl mx-auto leading-relaxed font-arabic">
