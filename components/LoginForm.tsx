...
import { FaUser, FaPhone, FaLock, FaEye, FaEyeSlash, FaSignInAlt } from 'react-icons/fa'
...
const LoginForm = () => {
  ...
  return (
    <section id="login" className="py-20 bg-gradient-to-br from-coffee-50 to-sakura-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="section-title">
            ...
            <br />
            <span className="text-2xl text-coffee-500 english-text font-medium">Login</span>
          </h2>
          <p className="text-lg text-coffee-500 max-w-3xl mx-auto leading-relaxed font-arabic">
            سجل دخولك إلى حسابك للوصول إلى جميع الميزات والعروض الحصرية
          </p>
        </motion.div>
        ...
        >
          <form onSubmit={handleSubmit} className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/20">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-coffee-500 to-coffee-600 hover:from-coffee-600 hover:to-coffee-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl font-arabic text-lg flex items-center justify-center gap-2"
            >
              <FaSignInAlt />
            ...
            <div className="mt-6 text-center space-y-3">
              <a href="#" className="block text-sakura-600 hover:text-sakura-700 font-medium text-sm font-arabic">
                نسيت كلمة السر؟
              </a>
              <div className="text-coffee-500 text-sm font-arabic">
                ليس لديك حساب؟{' '}
                <a href="#register" className="text-sakura-600 hover:text-sakura-700 font-medium">
                  سجل الآن
                </a>
              </div>
            </div>
