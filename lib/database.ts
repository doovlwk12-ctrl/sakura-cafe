  ...
  private initializeDefaultProducts() {
    this.products = [
      // المشروبات - DRINKS
      {
        id: 'hot-coffee-day',
        name: 'Hot Coffee Day',
        name_ar: 'قهوة اليوم حار',
        description: 'Traditional Turkish coffee with cardamom and saffron',
        description_ar: 'قهوة تركية تقليدية مع الهيل والزعفران',
        price: 18,
        category: 'drinks',
      ...
      },
      {
        id: 'ice-coffee-day',
        name: 'Ice Coffee Day',
        name_ar: 'قهوة اليوم بارد',
        description: 'Refreshing cold Turkish coffee with cardamom',
        description_ar: 'قهوة تركية باردة منعشة مع الهيل',
        price: 20,
        category: 'drinks',
      ...
      },
      {
        ...
        name: 'Flat White',
        name_ar: 'فلات وايت',
        description: 'Italian coffee with smooth steamed milk',
        description_ar: 'قهوة إيطالية مع حليب مبخر ناعم',
        price: 22,
        category: 'drinks',
      ...
      },
      {
        ...
        description_ar: 'قهوة إيطالية كلاسيكية مع رغوة الحليب',
        price: 20,
        category: 'drinks',
        image: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=400&h=300&fit=crop&auto=format',
        calories: 150,
      ...
      },
      {
        ...
        name: 'Hot Espresso',
        name_ar: 'اسبريسو حار',
        description: 'Concentrated and pure Italian coffee',
        description_ar: 'قهوة إيطالية مركزة ونقية',
        price: 15,
        category: 'drinks',
      ...
      },
      {
        id: 'ice-espresso',
        name: 'Ice Espresso',
        name_ar: 'اسبريسو بارد',
        description: 'Refreshing cold espresso',
        description_ar: 'اسبريسو باردة منعشة',
        price: 17,
        category: 'drinks',
        image: 'https://images.unsplash.com/photo-1510591509098-f4fdc6d0ff04?w=400&h=300&fit=crop&auto=format',
        calories: 90,
      ...
      },
      {
        ...
        name: 'Hot Latte',
        name_ar: 'لاتيه حار',
        description: 'Coffee with warm milk and smooth foam',
        description_ar: 'قهوة مع حليب دافئ ورغوة ناعمة',
        price: 22,
        category: 'drinks',
        image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&h=300&fit=crop&auto=format',
        calories: 180,
      ...
      },
      {
        ...
        description_ar: 'لاتيه باردة مع ثلج',
        price: 24,
        category: 'drinks',
        image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&h=300&fit=crop&auto=format',
        calories: 200,
      ...
      },
      {
        ...
        name_ar: 'اسبانيش لاتيه حار',
        description: 'Latte with sweetened condensed milk',
        description_ar: 'لاتيه مع الحليب المكثف المحلى',
        price: 25,
        category: 'drinks',
        image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&h=300&fit=crop&auto=format',
        calories: 220,
      ...
      },
      {
        ...
        name_ar: 'اسبانيش لاتيه بارد',
        description: 'Refreshing cold Spanish latte',
        description_ar: 'اسبانيش لاتيه باردة منعشة',
        price: 27,
        category: 'drinks',
        image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=400&h=300&fit=crop&auto=format',
        calories: 240,
      ...
      // الحلويات - SWEETS
      {
        ...
        description: 'Fresh French croissant with chocolate filling',
        description_ar: 'كرواسون فرنسي طازج مع حشوة الشوكولاتة',
        price: 12,
        category: 'sweet',
        image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400&h=300&fit=crop&auto=format',
        calories: 250,
        stock: 25,
        status: 'active',
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        name_ar: 'كرواسون عادي',
        description: 'Classic French croissant',
        description_ar: 'كرواسون فرنسي كلاسيكي',
        price: 10,
        category: 'sweet',
        image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400&h=300&fit=crop&auto=format',
        calories: 200,
      ...
      },
      {
        ...
        name_ar: 'مافن شوكولاتة',
        description: 'Fresh chocolate muffin',
        description_ar: 'مافن الشوكولاتة الطازج',
        price: 15,
        category: 'sweet',
        image: 'https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=400&h=300&fit=crop&auto=format',
        calories: 280,
        stock: 20,
        status: 'active',
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        name_ar: 'مافن توت أزرق',
        description: 'Fresh blueberry muffin',
        description_ar: 'مافن التوت الأزرق الطازج',
        price: 16,
        category: 'sweet',
        image: 'https://images.unsplash.com/photo-1486427944299-d1955d23e34d?w=400&h=300&fit=crop&auto=format',
        calories: 260,
      ...
      },
      {
        ...
        description_ar: 'حلوى تيراميسو إيطالية كلاسيكية',
        price: 18,
        category: 'sweet',
      ...
      },
      {
        ...
        description_ar: 'تشيز كيك على الطريقة النيويوركية',
        price: 20,
        category: 'sweet',
      ...
      // الساندويتشات - SANDWICHES
      {
        id: 'club-sandwich',
        name: 'Club Sandwich',
        name_ar: 'ساندويتش كلوب',
        description: 'Chicken club sandwich with fresh vegetables',
        description_ar: 'ساندويتش كلوب بالدجاج والخضار الطازجة',
        price: 25,
        category: 'sandwiches',
      ...
      },
      {
        ...
        description_ar: 'ساندويتش دجاج مشوي مع الخضار الطازجة',
        price: 22,
        category: 'sandwiches',
        image: 'https://images.unsplash.com/photo-1539252554453-80ab65ce3586?w=400&h=300&fit=crop&auto=format',
        calories: 400,
      ...
      },
      {
        ...
        description: 'Fresh tuna sandwich with vegetables',
        description_ar: 'ساندويتش تونة طازجة مع الخضار',
        price: 20,
        category: 'sandwiches',
        image: 'https://images.unsplash.com/photo-1539252554453-80ab65ce3586?w=400&h=300&fit=crop&auto=format',
        calories: 380,
      ...
      },
      {
        ...
        description_ar: 'سلطة سيزر طازجة مع الخبز المحمص',
        price: 18,
        category: 'sandwiches',
      ...
      // المجموعات - GROUPS
      {
        ...
        name_ar: 'إفطار عائلي',
        description: 'Complete breakfast set for the family',
        description_ar: 'وجبة إفطار كاملة للعائلة',
        price: 45,
        category: 'groups',
      ...
      },
      {
        ...
        name: 'Coffee Lovers Set',
        name_ar: 'مجموعة عشاق القهوة',
        description: 'Special coffee set for coffee enthusiasts',
        description_ar: 'مجموعة قهوة خاصة لعشاق القهوة',
        price: 35,
        category: 'groups',
        image: 'https://images.unsplash.com/photo-1551218808-94e220e084d2?w=400&h=300&fit=crop&auto=format',
        calories: 600,
      ...
      },
      {
        ...
        description_ar: 'طبق حلويات متنوعة',
        price: 30,
        category: 'groups',
        image: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400&h=300&fit=crop&auto=format',
        calories: 500,
